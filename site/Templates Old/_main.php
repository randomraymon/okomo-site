...
<body id="<?= $page->title ?>">
	...
	<menu class="menu" data-pw-id='menu'>
		<div class="menu__bar" data-pw-id='menu-bar'>
			<div class="logo">
			...
			<ul class="menu__bar__links">
				...
				<li><a class="<?= strtolower($pages->get("id=1057")->title) ?>" href="<?= $pages->get("id=1057")->url ?>"><?= $pages->get("id=1057")->title ?></a></li>
				<li><a class="<?= strtolower($pages->get("id=1054")->title) ?>" href="<?= $pages->get("id=1054")->url ?>"><?= $pages->get("id=1054")->title ?></a></li>
				<li class="button button__trial"><a href="<?= $pages->get("id=1069")->url ?>"><?= $pages->get("id=1069")->title ?></a></li>
			</ul>
	...
	<div data-pw-id="okomo-button" class="okomo-button"></div>
	...
	<footer data-pw-id="footer" class='footer'>
		...
		<ul class="social-media">
			<li><a href="#"><img src="/site/templates/assets/img/icon--facebook.svg" alt=""></a></li>
			<li><a href="#"><img src="/site/templates/assets/img/icon--twitter.svg" alt=""></a></li>
			<li><a href="#"><img src="/site/templates/assets/img/icon--linked-in.svg" alt=""></a></li>
			<li><a href="#"><img src="/site/templates/assets/img/icon--instagram.svg" alt=""></a></li>
		</ul>
