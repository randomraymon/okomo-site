...
<head>
	...
	<script type="text/javascript" src="/node_modules/greensock/dist/TweenMax.js"></script>
	<script type="text/javascript" src="/node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js"></script>
	<script type="text/javascript" src="/node_modules/scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap.js"></script>
...
<body id="<?= $page->title ?>">
	...
	<menu class="menu">
		<div class="menu__bar">
			...
			<ul class="menu__bar__links">
				<?php if($page->editable()) echo "<li class='edit'><a href='$page->editUrl'>" . __('Edit') . "</a></li>"; ?>
				...
				<!-- <li><a class="<?php //strtolower($pages->get("id=1057")->title) ?>" href="<?php //$pages->get("id=1057")->url ?>"><?php //$pages->get("id=1057")->title ?></a></li>
				<li><a class="<?php //strtolower($pages->get("id=1054")->title) ?>" href="<?php //$pages->get("id=1054")->url ?>"><?php //$pages->get("id=1054")->title ?></a></li> -->
				<li class="button button__trial"><a href="<?= strtolower($pages->get("id=1066")->title) ?>"><?= $pages->get("id=1069")->title ?></a></li>
			</ul>
	...
	<footer data-pw-id="footer" class='footer'>
		...
		if($user->isLoggedin()) {
			...
			echo "<a href='{$config->urls->admin}login/logout/'><div class='log-out-button'>" . sprintf(__('Logout (%s)'), $user->name) . "</div></a>";
		} else {
			// if user not logged in, show a login link
			echo "<a href='{$config->urls->admin}'><div class='log-in-button'" . __('Admin Login') . "</div></a>";
		}
		?>
		...
		<ul class="social-media">
			<li><a href="https://www.facebook.com/okomo.ch/"><img src="/site/templates/assets/img/icon--facebook.svg" alt=""></a></li>
			<li><a href="https://twitter.com/Okomo_com"><img src="/site/templates/assets/img/icon--twitter.svg" alt=""></a></li>
			<li><a href="https://www.linkedin.com/company/okomo-ch/"><img src="/site/templates/assets/img/icon--linked-in.svg" alt=""></a></li>
			<li><a href="https://www.instagram.com/okomo_com/"><img src="/site/templates/assets/img/icon--instagram.svg" alt=""></a></li>
		</ul>

		<p class="disclaimer--copyright">Copyright © 2018 Okomo AG. All rights reserved.</p>
	</footer>
	<script type="text/javascript" src="/site/templates/assets/scripts/script.js"></script>
	<script type="text/javascript">
	 ...
	 iframe.id = 'container'
	 iframe.onload = () => {
	 document.getElementById('showArrow').style.display = 'unset'
